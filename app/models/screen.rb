class Screen < ActiveRecord::Base
  ...
  has_attached_file :screenshot, styles: { desat_banner: "300x180#", banner: "300x180#", small_square: "130x130#", thumb: "30x30#" }, convert_options: { desat_banner: "-set option:modulate:colorspace hsb -modulate 88,50" }
