class Article < ActiveRecord::Base
  ...
  has_many :apptivist_articles, dependent: :destroy, inverse_of: :article
  has_many :featured_apptivists, through: :apptivist_articles, source: :apptivist
  ...
  attr_accessible :body, :title, :category_ids, :tool_ids, :featured, :published, :featured_image, :source_url, :search_tag_ids, :author_id, :image_credit, :featured_apptivist_ids
